...
const App = () => {
  ...
  const fallbackData = [
    ...
    {
      ticker: 'TERN', name: 'Terns Pharma', score: 88.0, target_area: 'Metabolic', is_past_deal: false, warning_flag: 'AI_TIMEOUT', // 模拟一个 AI 崩溃状态供演示
